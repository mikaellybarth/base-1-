...
const produto1 = new ProdutoDestaque ("canecaGato", "08/08/2006", "13579", "25.00", "https://cf.shopee.com.br/file/6306627181d6900a96d8c4165c44dd8d");
...
const produto1s = new ProdutoDestaque ("canecaGato", "08/08/2006", "13579", "25.00");
...
const produto2 = new ProdutoDestaque ("bolsagato", "09/09/2007", "97531", "35.00", "https://i.pinimg.com/236x/2d/cf/74/2dcf74e6881d0d0865eb2441b4445ee8.jpg");
...
const produto2s = new ProdutoDestaque ("bolsagato", "09/09/2007", "97531", "35.00");
...
const produto3 = new ProdutoDestaque ("quadrogatomonalisa", "07/07/2007", "2468", "50.00", "https://cdn.awsli.com.br/300x300/579/579637/produto/77592776/cc9cbacc14.jpg");
...
const produto3s = new ProdutoDestaque ("quadrogatomonalisa", "07/07/2007", "2468", "50.00");
...
const produto4 = new ProdutoDestaque ("quadrogtmona", "05/05/2005", "0000", "55.00", "https://img.travessa.com.br/livro/BA/0c/0c9ef803-a970-45cd-a403-ccd8ac0e5f09.jpg");
...
const produto4s = new ProdutoDestaque ("quadrogtmona", "05/05/2005", "0000", "55.00");
...
const produto5 = new ProdutoDestaque ("slamudar tudo", "05/05/2005", "0000", "55.00", "https://m.media-amazon.com/images/S/aplus-media-library-service-media/c936f1de-126e-4d6d-9e94-b442a1de13a7.__CR0,0,1250,1250_PT0_SX300_V1___.png");
...
const produto5s = new ProdutoDestaque ("slamudar tudo", "05/05/2005", "0000", "55.00");
